...
//    }
	...
	public String getPay(@PathVariable Long price) throws UnsupportedEncodingException{
		int contractId = 1;
        ...
        vnp_Params.put("vnp_ReturnUrl", PaymentConfig.vnp_ReturnUrl+"?contractId="+contractId);
